...
| 2.   | [Новая модель монетизации мобильной](https://github.com/anngnk/Portfolio/tree/main/game_monetisation) | Выбор новой модели монетизации, вызывающей меньшее раздражение у игроков, при этом все еще окупающейся | python, pandas, numpy, scipy.stats, plotly, seaborn, matplotlib, tableau |
